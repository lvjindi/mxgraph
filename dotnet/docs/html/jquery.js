...
(function (bb, L) {
    ...
    var b = (function () {
        var bF = function (b0, b1) {
            ...
            }, bU = bb.jQuery, bH = bb.$, bD, bY = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, bM = /\S/, bI = /^\s+/,
            bE = /\s+$/, bA = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, bN = /^[\],:{}\s]*$/,
            bW = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
            bP = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, bJ = /(?:^|:|,)(?:\s*\[)+/g,
            by = /(webkit)[ \/]([\w.]+)/, bR = /(opera)(?:.*version)?[ \/]([\w.]+)/, bQ = /(msie) ([\w.]+)/,
            bS = /(mozilla)(?:.*? rv:([\w.]+))?/, bB = /-([a-z]|[0-9])/ig, bZ = /^-ms-/, bT = function (b0, b1) {
                return (b1 + "").toUpperCase()
            }, bX = bu.userAgent, bV, bC, e, bL = Object.prototype.toString, bG = Object.prototype.hasOwnProperty,
            bz = Array.prototype.push, bK = Array.prototype.slice, bO = String.prototype.trim,
            bv = Array.prototype.indexOf, bx = {};
        bF.fn = bF.prototype = {
        ...
        bF.extend({
            noConflict: function (b0) {
                ...
                var b5, b6, b4 = [], b2 = 0, b1 = b0.length,
    ...
    b.extend({
        Deferred: function (by) {
            var bx = b.Callbacks("once memory"), bw = b.Callbacks("once memory"), bv = b.Callbacks("memory"),
                e = "pending", bA = {resolve: bx, reject: bw, notify: bv}, bC = {
            ...
            var bx = aJ.call(arguments, 0), bv = 0, e = bx.length, bB = new Array(e), bw = e, by = e,
                bC = e <= 1 && bA && b.isFunction(bA.promise) ? bA : b.Deferred(), bE = bC.promise();
    ...
    b.extend({
        ...
        data: function (bx, bv, bz, by) {
            ...
            var bG, bA, bD, bE = b.expando, bC = typeof bv === "string", bF = bx.nodeType, e = bF ? b.cache : bx,
                bw = bF ? bx[bE] : bx[bE] && bE, bB = bv === "events";
    ...
    b.fn.extend({
        queue: function (e, bv) {
            ...
            bD = bD || "fx";
            var e = b.Deferred(), bv = this, by = bv.length, bB = 1, bz = bD + "defer", bA = bD + "queue",
                bC = bD + "mark", bx;
    ...
    var aP = /[\n\t\r]/g, af = /\s+/, aU = /\r/g, g = /^(?:button|input)$/i,
        D = /^(?:button|input|object|select|textarea)$/i, l = /^a(?:rea)?$/i,
        ...
        F = b.support.getSetAttribute, be, aY, aF;
    b.fn.extend({
        attr: function (e, bv) {
    ...
    var bd = /^(?:textarea|input|select)$/i, n = /^([^\.]*)?(?:\.(.+))?$/, J = /\bhover(\.\S+)?\b/, aO = /^key/,
        bf = /^(?:mouse|contextmenu)|click/, T = /^(?:focusinfocus|focusoutblur)$/,
        U = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, Y = function (e) {
            var bv = U.exec(e);
            if (bv) {
    ...
    b.event = {
        ...
        dispatch: function (e) {
            ...
            var bz = ((b._data(this, "events") || {})[e.type] || []), bA = bz.delegateCount,
                bG = [].slice.call(arguments, 0), by = !e.exclusive && !e.namespace, bH = [], bC, bB, bK, bx, bF, bE,
                bv, bD, bI, bw, bJ;
            bG[0] = e;
        ...
        fix: function (bw) {
            ...
            var bv, bz, e = bw, bx = b.event.fixHooks[bw.type] || {},
...
(function (b, d) {
    ...
    b.Widget.prototype = {
        widgetName: "widget", widgetEventPrefix: "", options: {disabled: false}, _createWidget: function (f, g) {
...
(function (b) {
    ...
    function e(h, i) {
        ...
        h.preventDefault();
        var j = h.originalEvent.changedTouches[0], g = document.createEvent("MouseEvents");
...
(function (a) {
    ...
    var b = [], e = !!window.createPopup, f = false, d = "ontouchstart" in window, h = false,
        g = window.requestAnimationFrame || function (l) {
            return setTimeout(l, 1000 / 60)
        }, c = window.cancelAnimationFrame || function (l) {
            clearTimeout(l)
        };
    ...
    function k(m) {
        ...
        if (!h && !m) {
            var o = true, l = null;
            a(document).bind(i([["mousemove", function (s) {
                var t = {x: s.pageX, y: s.pageY, timeStamp: new Date().getTime()};
                if (l) {
                    var q = Math.abs(l.x - t.x), p = Math.abs(l.y - t.y);
                    if ((q > 0 || p > 0) && q <= 2 && p <= 2 && t.timeStamp - l.timeStamp <= 300) {
                        f = true;
                        if (o) {
                ...
                l = t
            }], [d ? "touchstart" : "pointerover pointermove pointerout MSPointerOver MSPointerMove MSPointerOut", function (p) {
        ...
        hideAll: function () {
            ...
            init: function (n) {
                ...
                if (!n) {
                    ...
                    var r = ".smartmenus";
                    this.$root.data("smartmenus", this).attr("data-smartmenus-id", this.rootId).dataSM("level", 1).bind(i([["mouseover focusin", a.proxy(this.rootOver, this)], ["mouseout focusout", a.proxy(this.rootOut, this)], ["keydown", a.proxy(this.rootKeyDown, this)]], r)).delegate("a", i([["mouseenter", a.proxy(this.itemEnter, this)], ["mouseleave", a.proxy(this.itemLeave, this)], ["mousedown", a.proxy(this.itemDown, this)], ["focus", a.proxy(this.itemFocus, this)], ["blur", a.proxy(this.itemBlur, this)], ["click", a.proxy(this.itemClick, this)]], r));
                    r += this.rootId;
                    if (this.opts.hideOnClick) {
                        a(document).bind(i([["touchstart", a.proxy(this.docTouchStart, this)], ["touchmove", a.proxy(this.docTouchMove, this)], ["touchend", a.proxy(this.docTouchEnd, this)], ["click", a.proxy(this.docClick, this)]], r))
                    }
                ...
                if (this.opts.markCurrentItem) {
                    var p = /(index|default)\.[^#\?\/]*/i, m = /#.*/, q = window.location.href.replace(p, ""),
                        o = q.replace(m, "");
                    this.$root.find("a").each(function () {
                        var s = this.href.replace(p, ""), t = a(this);
                        if (s == q || s == o) {
                            t.addClass("current");
                ...
                if (!m) {
                    var n = ".smartmenus";
                    this.$root.removeData("smartmenus").removeAttr("data-smartmenus-id").removeDataSM("level").unbind(n).undelegate(n);
                    n += this.rootId;
                    a(document).unbind(n);
                    a(window).unbind(n);
                    if (this.opts.subIndicators) {
                ...
                this.$root.find("ul").each(function () {
                    ...
                    if (o.dataSM("shown-before")) {
                        if (l.opts.subMenusMinWidth || l.opts.subMenusMaxWidth) {
                            o.css({width: "", minWidth: "", maxWidth: ""}).removeClass("sm-nowrap")
                        }
                        if (o.dataSM("scroll-arrows")) {
                            o.dataSM("scroll-arrows").remove()
                        }
                ...
                if (this.visibleSubMenus.length && !a.contains(this.$root[0], l.target) || a(l.target).is("a")) {
                    this.menuHideAll()
                }
                ...
                if (this.visibleSubMenus.length && (this.lastTouch.x2 === undefined || this.lastTouch.x1 == this.lastTouch.x2) && (this.lastTouch.y2 === undefined || this.lastTouch.y1 == this.lastTouch.y2) && (!this.lastTouch.target || !a.contains(this.$root[0], this.lastTouch.target))) {
                    if (this.hideTimeout) {
                ...
                if (n.css("display") == "none") {
                    m = {position: n[0].style.position, visibility: n[0].style.visibility};
                    n.css({position: "absolute", visibility: "hidden"}).show()
                }
                var o = n[0].getBoundingClientRect && n[0].getBoundingClientRect(),
                    p = o && (l ? o.height || o.bottom - o.top : o.width || o.right - o.left);
                if (!p && p !== 0) {
                ...
                return l.touches && l.touches[0] || l.changedTouches && l.changedTouches[0] || l
            }, getViewport: function (l) {
                var m = l ? "Height" : "Width", o = document.documentElement["client" + m], n = window["inner" + m];
                if (n) {
                    o = Math.min(o, n)
                }
                return o
                ...
                var n = p.closest("ul"), q = n.dataSM("level");
                if (q > 1 && (!this.activatedItems[q - 2] || this.activatedItems[q - 2][0] != n.dataSM("parent-a")[0])) {
                    var m = this;
                    a(n.parentsUntil("[data-smartmenus-id]", "ul").get().reverse()).add(n).each(function () {
                        m.itemActivate(a(this).dataSM("parent-a"))
                    })
                }
                if (!this.isCollapsible() || l) {
                    this.menuHideSubMenus(!this.activatedItems[q - 1] || this.activatedItems[q - 1][0] != p[0] ? q - 1 : q)
                }
                ...
                var o = p.dataSM("sub");
                if (o && (this.isTouchMode() || (!this.opts.showOnClick || this.clickActivated))) {
                    this.menuShow(o)
                }
            }, itemBlur: function (m) {
                ...
                if (this.$touchScrollingSub && this.$touchScrollingSub[0] == n.closest("ul")[0]) {
                    this.$touchScrollingSub = null;
                    o.stopPropagation();
                    return false
                }
                ...
                var p = a(o.target).is("span.sub-arrow"), m = n.dataSM("sub"), l = m ? m.dataSM("level") == 2 : false;
                if (m && !m.is(":visible")) {
                ...
                if (this.opts.showOnClick && l || n.hasClass("disabled") || this.$root.triggerHandler("select.smapi", n[0]) === false) {
                    return false
                }
            }, itemDown: function (m) {
                var l = a(m.currentTarget);
                ...
                if (!this.isTouchMode()) {
                    ...
                    this.showTimeout = setTimeout(function () {
                        l.itemActivate(m)
                    }, this.opts.showOnClick && m.closest("ul").dataSM("level") == 1 ? 1 : this.opts.showTimeout)
                }
                ...
                if (this.focusActivated && (!this.isTouchMode() || !l.dataSM("mousedown")) && (!this.activatedItems.length || this.activatedItems[this.activatedItems.length - 1][0] != l[0])) {
                ...
                if (m.css("display") != "none") {
                    ...
                    if (m.dataSM("ie-shim")) {
                        m.dataSM("ie-shim").remove().css({"-webkit-transform": "", transform: ""})
                    }
                    if (m.dataSM("scroll")) {
                    ...
                    m.dataSM("parent-a").removeClass("highlighted").attr("aria-expanded", "false");
                ...
                if (e && this.opts.overlapControlsInIE && !l.dataSM("ie-shim")) {
                    l.dataSM("ie-shim", a("<iframe/>").attr({
                        src: "javascript:0",
                        tabindex: -9
                ...
                var r = K.dataSM("parent-a"), D = r.closest("li"), E = D.parent(), l = K.dataSM("level"),
                    t = this.getWidth(K), J = this.getHeight(K), u = r.offset(), o = u.left, m = u.top,
                    q = this.getWidth(r), F = this.getHeight(r), H = a(window), v = H.scrollLeft(), s = H.scrollTop(),
                    z = this.getViewportWidth(), L = this.getViewportHeight(),
                    w = E.parent().is("[data-sm-horizontal-sub]") || l == 2 && !E.hasClass("sm-vertical"),
                    B = this.opts.rightToLeftSubMenus && !D.is("[data-sm-reverse]") || !this.opts.rightToLeftSubMenus && D.is("[data-sm-reverse]"),
                    p = l == 2 ? this.opts.mainMenuSubOffsetX : this.opts.subMenusSubOffsetX,
                    n = l == 2 ? this.opts.mainMenuSubOffsetY : this.opts.subMenusSubOffsetY, C, A;
                if (w) {
                    C = B ? q - t - p : p;
                ...
                if (this.opts.keepInViewport) {
                    ...
                    if (w && (M + J > s + L + 0.49 || M < s) || !w && J > L + 0.49) {
                        ...
                        if (!K.dataSM("scroll-arrows")) {
                            K.dataSM("scroll-arrows", a([a('<span class="scroll-up"><span class="scroll-up-arrow"></span></span>')[0], a('<span class="scroll-down"><span class="scroll-down-arrow"></span></span>')[0]]).bind({
                                mouseenter: function () {
                        ...
                        K.dataSM("scroll", {
                            ...
                            width: t - (parseInt(K.css("border-left-width")) || 0) - (parseInt(K.css("border-right-width")) || 0),
                        ...
                        if (this.isFixed()) {
                            ...
                            }).bind(i([[d ? "touchstart touchmove touchend" : "pointerdown pointermove pointerup MSPointerDown MSPointerMove MSPointerUp", function (x) {
                ...
                var p = r.dataSM("scroll"), q = r.dataSM("scroll-arrows"), o = p.up ? p.upEnd : p.downEnd, s;
                if (!m && p.momentum) {
                    p.momentum *= 0.92;
                    s = p.momentum;
                    if (s < 0.5) {
                    ...
                    s = n || (m || !this.opts.scrollAccelerate ? this.opts.scrollStep : Math.floor(p.step))
                }
                var l = r.dataSM("level");
                if (this.activatedItems[l - 1] && this.activatedItems[l - 1].dataSM("sub") && this.activatedItems[l - 1].dataSM("sub").is(":visible")) {
                    this.menuHideSubMenus(l - 1)
                }
                p.y = p.up && o <= p.y || !p.up && o >= p.y ? p.y : (Math.abs(o - p.y) > s ? p.y + (p.up ? s : -s) : o);
                r.add(r.dataSM("ie-shim")).css(this.cssTransforms3d ? {
                ...
                if (this.getClosestMenu(n.target) == m[0]) {
                    ...
                    if (m.dataSM("scroll-arrows").eq(l ? 0 : 1).is(":visible")) {
                ...
                if (f) {
                    if (!/^scroll-(up|down)/.test((m.relatedTarget || "").className) && (l[0] != m.relatedTarget && !a.contains(l[0], m.relatedTarget) || this.getClosestMenu(m.relatedTarget) != l[0])) {
                        l.dataSM("scroll-arrows").css("visibility", "hidden")
                    }
                }
            }, menuScrollOver: function (n, o) {
                if (f) {
                    if (!/^scroll-(up|down)/.test(o.target.className) && this.getClosestMenu(o.target) == n[0]) {
                        this.menuScrollRefreshData(n);
                        var m = n.dataSM("scroll"),
                            l = a(window).scrollTop() - n.dataSM("parent-a").offset().top - m.itemH;
                        n.dataSM("scroll-arrows").eq(0).css("margin-top", l).end().eq(1).css("margin-top", l + this.getViewportHeight() - m.arrowDownH).end().css("visibility", "visible")
                    }
                }
            }, menuScrollRefreshData: function (n) {
                var m = n.dataSM("scroll"), l = a(window).scrollTop() - n.dataSM("parent-a").offset().top - m.itemH;
                        ...
                        if (/(start|down)$/i.test(q.type)) {
                            ...
                            if (/move$/i.test(q.type)) {
                                ...
                                if (o.touchY !== undefined) {
                                    if (o.momentum = Math.pow(Math.abs(m.pageY - o.touchStartY) / (q.timeStamp - o.touchStartTime), 2) * 15) {
                ...
                if (!n.dataSM("beforefirstshowfired")) {
                    ...
                    if (this.$root.triggerHandler("beforefirstshow.smapi", n[0]) === false) {
                        return
                    }
                }
                ...
                if (!n.is(":visible")) {
                    ...
                    if (this.isCollapsible()) {
                        ...
                        n.css("z-index", this.zIndexInc = (this.zIndexInc || this.getStartZIndex()) + 1);
                        if (this.opts.subMenusMinWidth || this.opts.subMenusMaxWidth) {
                            n.css({width: "auto", minWidth: "", maxWidth: ""}).addClass("sm-nowrap");
                            ...
                            if (this.opts.subMenusMaxWidth) {
                                ...
                                if (o > this.getWidth(n)) {
                                    n.removeClass("sm-nowrap").css("width", this.opts.subMenusMaxWidth)
                                }
                            }
                        }
                        this.menuPosition(n);
                ...
                if (!this.handleEvents() || this.isTouchMode() || m.target == this.$root[0]) {
                    return
                }
                if (this.hideTimeout) {
                    clearTimeout(this.hideTimeout);
                ...
                if (!this.handleEvents() || this.isTouchMode() || l.target == this.$root[0]) {
                    return
                }
                if (this.hideTimeout) {
                    clearTimeout(this.hideTimeout);
                ...
                if (!("onorientationchange" in window) || m.type == "orientationchange") {
