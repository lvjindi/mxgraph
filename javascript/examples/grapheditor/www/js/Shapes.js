...
(function () {
        ...
        mxUtils.extend(InitialShape, mxShape);

        InitialShape.prototype.getLabelMargins = function (rect) {
            return new mxRectangle(rect.width / 6, 0, 0, 0);
        };
        ...
        InitialShape.prototype.isHtmlAllowed = function () {
            var events = true;
        ...
        InitialShape.prototype.paintForeground = function (c, x, y, w, h) {
            if (!this.outline) {
...
//---------------------------------------------------------------------------------------------------------------------
        ...
        AutomatonShape.prototype.getConstraints = function (style, w, h) {
            ...
            constr = [new mxConnectionConstraint(new mxPoint(0.25, 0), true),
                new mxConnectionConstraint(new mxPoint(0.5, 0), true),
                new mxConnectionConstraint(new mxPoint(0.75, 0), true),
                new mxConnectionConstraint(new mxPoint(0, 0.25), true),
                new mxConnectionConstraint(new mxPoint(0, 0.5), true),
        ...
        InitialShape.prototype.getConstraints = function (style, w, h) {
            var constr = [];
            var s = Math.max(0, Math.min(w, Math.min(h, parseFloat(mxUtils.getValue(this.style, 'size', this.size)))));
