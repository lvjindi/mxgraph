 ...
 * value - Object that defines the new user object.
 */
mxGraphModel.prototype.setName = function (cell, value) {
    this.execute(new mxNameChange(this, cell, value));
 ...
 * value - Object that defines the new user object.
 */
mxGraphModel.prototype.setInvariant = function (cell, value) {
    this.execute(new mxInvariantChange(this, cell, value));
 ...
 * value - Object that defines the new user object.
 */
mxGraphModel.prototype.setRateOfExponential = function (cell, value) {
    this.execute(new mxRateOfExponentialChange(this, cell, value));
...
mxGraphModel.prototype.invariantForCellChanged = function (cell, value) {
    return cell.invariantChanged(value);
};

mxGraphModel.prototype.rateOfExponentialForCellChanged = function (cell, value) {
    return cell.rateOfExpoentialChanged(value);
};
/**
 ...
 * specified model.
 */
function mxNameChange(model, cell, value) {
    this.model = model;
    this.cell = cell;
    this.name = value;
    this.previous = value;
 ...
 * specified model.
 */
function mxInvariantChange(model, cell, value) {
    this.model = model;
    this.cell = cell;
...
/**
 * Class: mxRateOfExponentialChange
 *
 * Action to change a user object in a model.
 *
 * Constructor: mxValueChange
 ...
 * specified model.
 */
function mxRateOfExponentialChange(model, cell, value) {
    this.model = model;
    this.cell = cell;
    this.rateOfExpoential = value;
    this.previous = value;
};
/**
 * Function: execute
 ...
 * <mxGraphModel.valueForCellChanged>.
 */
mxNameChange.prototype.execute = function () {
    if (this.cell != null) {
        this.name = this.previous;
        this.previous = this.model.nameForCellChanged(
            this.cell, this.previous);
    }
};
/**
 ...
 * <mxGraphModel.valueForCellChanged>.
 */
mxInvariantChange.prototype.execute = function () {
    if (this.cell != null) {
        this.invariant = this.previous;
        this.previous = this.model.invariantForCellChanged(
            this.cell, this.previous);
    }
};
/**
 ...
 * <mxGraphModel.valueForCellChanged>.
 */
mxRateOfExponentialChange.prototype.execute = function () {
    if (this.cell != null) {
        this.invariant = this.previous;
        this.previous = this.model.rateOfExponentialForCellChanged(
            this.cell, this.previous);
    }
};
