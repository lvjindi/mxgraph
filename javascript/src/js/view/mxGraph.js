 ...
 * style - Optional string that defines the cell style.
 */
mxGraph.prototype.insertEdge = function (parent, id, value, source, target, guard, style) {
    var edge = this.createEdge(parent, id, value, source, target, guard, style);
 ...
 *
 */
mxGraph.prototype.createEdge = function (parent, id, value, source, target, guard, style) {
    // Creates the edge
